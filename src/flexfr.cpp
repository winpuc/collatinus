...
const QStringList voix = QStringList() << "actif"<<"passif";
const QStringList genres = QStringList() <<"masculin"<<"féminin";
const QStringList nombres = QStringList() << "singulier"<<"pluriel";
